...
namespace GogoGaga.OptimizedRopesAndCables
{
    ...
    {
        [Range(3, 50)] public int OverallDivision = 6;
        [Range(0.01f, 10)] public float ropeWidth = 0.3f;
        [Range(3, 40)] public int radialDivision = 8;
        ...
        public void CreateRopeMesh(Vector3[] points, float radius, int segmentsPerWire)
        {
            ...
            Color startColor = Color.Lerp(Color.black, Color.white, 0f);
            ...
            Color endColor = Color.Lerp(Color.black, Color.white, 1f);
            colors.Add(endColor);
            ...
            ropeMesh.colors = colors.ToArray();
        }
        ...
        public void GenerateMesh()
        {
            ...
            Debug.Log("Trying to Generate Mesh");
